namespace MyNamespaceSecond
{
    ...
    /// </summary>
    public unsafe class MyClassSecond
    {
        /// <summary>
        /// Enter description here for the first constructor.
        /// ID string generated is "M:MyNamespace.MyClass.#ctor".<sub>[Expand]</sub>
        /// </summary>
        public MyClass() { }
        ...
        /// </summary>
        /// <param name="t"> Целочисленный параметр.</param>
        public MyClass(int t) { }

        /// <details>
        /// <summary>
        /// :page_facing_up: Test wow <sub>[Expand]</sub>
        /// </summary>
        /// <p>
